...
test "OK" {
    ...
    try expected_values.append(2.0400000E+01);
    try expected_values.append(9.3600001E+01);
    try expected_values.append(2.2870000E+02);
    try expected_values.append(1.1230000E+02);
    try expected_values.append(1.1225000E+02);
